...
public class Ejercicio1 {
	...
	/*
	 * public static int escogerNumeroAzar () { String inferior =
	 * JOptionPane.showInputDialog("Escoge el límite inferior");
	 * Float.parseFloat(inferior); String superior =
	 * JOptionPane.showInputDialog("Escoge el límite inferior");
	 * Float.parseFloat(superior); return (int) Math.round(Math.random() inferior,
	 * superior); };
	 */
	/**
	 * Método principal
	...
	public static void main(String[] args) {
		 ...
		 * // mayor y el menor mayor = numeros[0]; menor = numeros[0]; suma =
		 * numeros[0];
		 * 
		 * // Una vez he trabajado con el primer elemento del array, recorro a partir de
		 * // la posición 1 para descubrir mayores y menores, y calcular la suma for
		 * (int i = 1; i < numeros.length; i++) { suma += numeros[i]; if (numeros[i] >
		 * mayor) { mayor = numeros[i]; } if (numeros[i] < menor) { menor = numeros[i];
		 * } }
		 * 
