...
//		}
	...
	/*
	 * public static String eliminarLinea (List<String> lista) { String linea =
	 * JOptionPane.showInputDialog("Añadir línea de texto:");
	 * 
	 * return linea; }
	 */
...
//		System.out.println("\n\nContenido del fichero");
		...
		/*
		 * for (int i = 0; i < lista.size(); i++) { System.out.println("\t" + i + " - "
		 * + lista.get(i)); }
		 */ return numeroLinea;
	}
