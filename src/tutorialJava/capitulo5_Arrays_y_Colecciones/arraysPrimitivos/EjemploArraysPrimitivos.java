...
public class EjemploArraysPrimitivos {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * // Otra forma de inicializar el array int array2[] = new int[] {88, 89, 90,
		 * 4, 5, 6, 7, 8, 9, 10};
		 * 
		 * // Recorrido del array para imprimir sus valores en pantalla for (int i :
		 * array2) { System.out.println(i); }
		 */
	}
